...
> - `Techcorp` may not be preloaded in shared lab environments. If you cannot find it, create it first by following [`business-entity-creation-use-case-owner.md`](../../instructor/business-entity-creation-use-case-owner.md).
