...
<img width="800" alt="Retrieve the Use Case, you need to validate and scroll-down to the models section:" src="./assets/valid_uc_models_proposed.png">
...
<img width="350" alt="Please review the two workflows:" src="./assets/valid_model_onboarding_process.png">
<img width="350" alt="Please review the two workflows:" src="./assets/valid_prompt_lifecycle_prompt.png">
...
First though, you need to start the overall UseCase Validation process, this can be achieved by clicking on the **Submit for Validation** button in the Actions menu of the UseCase record.

<img width="800" alt="First though, you need to start the overall UseCase Validation process, this can be achieved by clicking on..." src="./assets/valid_uc_submit_for_validation.png">
...
<img width="800" alt="Click on the Model record and fill in some missing information, like the Model Owner:" src="./assets/valid_model_set_owner.png">

Then start the Model Onboarding Process:

<img width="800" alt="Then start the Model Onboarding Process:" src="./assets/valid_model_submit_onboarding.png">

Click on continue

<img width="800" alt="Click on continue" src="./assets/valid_model_onboarding_continue.png">

Go back to your list on Task:

<img width="800" alt="Go back to your list on Task:" src="./assets/valid_validator_task.png">
...
<img width="200" alt="First, fill and submit the questionnaire (avoid identifying any Risks on the Model):" src="./assets/valid_model_questionnaire.png">
<img width="200" alt="First, fill and submit the questionnaire (avoid identifying any Risks on the Model):" src="./assets/valid_model_questionnaire2.png">
<img width="200" alt="First, fill and submit the questionnaire (avoid identifying any Risks on the Model):" src="./assets/valid_model_questionnaire_submit.png">

The go back to the Risk Assessment Task on the Model and Click **Submit for approved Task Selection**:<br>
<img width="800" alt="The go back to the Risk Assessment Task on the Model and Click Submit for approved Task Selection:" src="./assets/valid_model_submit_approved_task_selection.png">
...
<img width="800" alt="If you go back to your task list, you should have less validation tasks:" src="./assets/valid_model_model_approval_task_less.png">
...
<img width="800" alt="And if you go back to the UseCase record and the Model section, the IBM Granite foundation model is now..." src="./assets/valid_model_approved_for_deployment.png">
...
Go back to the UseCase record, locate the **Agentic RAG LangChain** record and click on it.

Fill in missing information like the external link (fill in dummy information, we haven't deploy the agent for real): <br>
<img width="800" alt="Fill in missing information like the external link (fill in dummy information, we haven't deploy the agent..." src="./assets/valid_prompt_set_missing_external_url.png">

Locate other missing fields:<br>
<img width="800" alt="Locate other missing fields:" src="./assets/valid_rag1_missing.png">

!! Important, set all stakeholder to yourself and the model monitor to watsonx.governance<br>
<img width="800" alt="!! Important, set all stakeholder to yourself and the model monitor to watsonx.governance" src="./assets/valid_rag_missing_stakeholder.png">

And start the Model Lifecycle Process:<br>
<img width="800" alt="And start the Model Lifecycle Process:" src="./assets/valid_model_start_lifecycle.png">
...
<img width="800" alt="Once the evaluation has been performed, you should see the updated metrics in the Governance Console:" src="./assets/valid_rag_metrics.png">
...
<img width="800" alt="the UseCase/Model Risk Assessement Questionnaire." src="./assets/valid_uc1_tasks.png">
...
<img width="250" alt="Please fill in the questionnaire such as no new Risk is identified. You can copy an Instructor Questionnaire..." src="./assets/valid_uc1_questionnaire.png">
<img width="250" alt="Please fill in the questionnaire such as no new Risk is identified. You can copy an Instructor Questionnaire..." src="./assets/valid_uc_questionnaire1.png">
<img width="250" alt="Please fill in the questionnaire such as no new Risk is identified. You can copy an Instructor Questionnaire..." src="./assets/valid_uc_questionnaire_submit.png">

Going back to the HomeScreen on the Tasks tab, you should have only one task remaining, **one final task**:<br>
<img width="800" alt="Going back to the HomeScreen on the Tasks tab, you should have only one task remaining, one final task:" src="./assets/valid_uc2_tasks.png">

Access this task and review the UseCase, note you can see a graph of all related objects under this Use Case:<br>
<img width="800" alt="Access this task and review the UseCase, note you can see a graph of all related objects under this Use Case:" src="./assets/valid_uc3_review.png">

Make sure everything is **approved**, and then click on **Start Use Case Deployment Approval**<br>

<img width="800" alt="Make sure everything is approved, and then click on Start Use Case Deployment Approval" src="./assets/valid_uc_start_deployment_approval.png">
---
