...
3. Upload the file [hr_queries_with_ground_truth_granite_4h_failing.csv](../validator/assets/hr_queries_with_ground_truth_granite_4h_failing.csv). It contains a couple of failing inferences from a real system
