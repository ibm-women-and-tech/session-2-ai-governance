...
<img width="800" alt="Navigate to My Tasks" src="./assets/StakeholderReview_Home.png">

* Locate your Use Case — it will be named **"&lt;initials&gt;_AskHR Automation using Agentic AI"**:

<img width="800" alt="Locate: “HR process automation using Agentic AI” which is Usecase name:" src="./assets/StakeholderReview_Task.png">
...
<img width="800" alt="Review Risks and Reviews associated with the UseCase." src="./assets/StakeholderReview_review.png">
...
<img width="800" alt="Since all stakeholders have approved the Use Case, you may set the global Risk Rating for your Use Case in..." src="./assets/UseCaseRiskRating.png">
...
<img width="800" alt="move the Use Case to the Approved for Development stage by clicking on the Approve for Development button in..." src="./assets/UseCaseApproveForDevelopment.png">
